...
- [1 Front-End](#1-front-end)
  ...
  - [1.8 Section6. 중급 CSS와 반응형 기능](#18-section6-중급-css와-반응형-기능)
    ...
    - [1.8.2 CSS media query와 반응형(responsive) 레이아웃](#182-css-media-query와-반응형responsive-레이아웃)
      ...
      - [1.8.2.4 참고해상도](#1824-참고해상도)
      - [1.8.2.5 미디어 쿼리 예시](#1825-미디어-쿼리-예시)
  ...
  - [1.11 Section9. Javascript(Vanilla JS) 기본 지식과 변수/조건문](#111-section9-javascriptvanilla-js-기본-지식과-변수조건문)
    - [1.11.1 Javascript 기본](#1111-javascript-기본)
      - [1.11.1.1 변수](#11111-변수)
      - [1.11.1.2 데이터 타입](#11112-데이터-타입)
        - [1.11.1.2.1 Number](#111121-number)
        - [1.11.1.2.2 Boolean](#111122-boolean)
        - [1.11.1.2.3 null과 undefined](#111123-null과-undefined)
        - [1.11.1.2.4 object](#111124-object)
        - [1.11.1.2.5 Symbol](#111125-symbol)
        - [1.11.1.2.6 데이터 타입 변환](#111126-데이터-타입-변환)
        - [1.11.1.2.7 주요 연산자](#111127-주요-연산자)
      - [1.11.1.3 조건문](#11113-조건문)
        - [1.11.1.3.1 if문](#111131-if문)
        - [1.11.1.3.2 switch/case 문](#111132-switchcase-문)
      - [1.11.1.4 함수](#11114-함수)
        - [1.11.1.4.1 함수 선언](#111141-함수-선언)
        - [1.11.1.4.2 ES6 화살표 함수Arrow function](#111142-es6-화살표-함수arrow-function)
  - [1.12 Section10. Javascript(Vanilla JS) 함수와 객체](#112-section10-javascriptvanilla-js-함수와-객체)
    - [1.12.1 객체 선언기법 이해](#1121-객체-선언기법-이해)
      - [1.12.1.1 객체](#11211-객체)
        - [1.12.1.1.1 객체 생성 방법](#112111-객체-생성-방법)
        - [1.12.1.1.2 객체 리터럴 사용시 주의사항](#112112-객체-리터럴-사용시-주의사항)
        - [1.12.1.1.3 getter / setter](#112113-getter--setter)
      - [1.12.1.2 ES6 클래스](#11212-es6-클래스)
        - [1.12.1.2.1 정의](#112121-정의)
        - [1.12.1.2.2 상속](#112122-상속)
        - [1.12.1.2.3 `hasOwnProperty()` 사용법](#112123-hasownproperty-사용법)
  - [1.13 Section11. Javascript(Vanilla JS) 반복문/배열](#113-section11-javascriptvanilla-js-반복문배열)
    - [1.13.1 for문](#1131-for문)
      - [1.13.1.1 배열과 for문](#11311-배열과-for문)
      - [1.13.1.2 객체와 for문](#11312-객체와-for문)
        - [1.13.1.2.1 `for ..in` 객체의 키를 반복](#113121-for-in-객체의-키를-반복)
        - [1.13.1.2.2 객체의 키와 값을 반복](#113122-객체의-키와-값을-반복)
    - [1.13.2 while문](#1132-while문)
    - [1.13.3 break와 continue](#1133-break와-continue)
    - [1.13.4 javascript 배열](#1134-javascript-배열)
      - [1.13.4.1 CRUD](#11341-crud)
        - [1.13.4.1.1 배열 생성(CREATE)](#113411-배열-생성create)
        - [1.13.4.1.2 배열 읽기(READ)](#113412-배열-읽기read)
        - [1.13.4.1.3 배열 수정(UPDATE)](#113413-배열-수정update)
        - [1.13.4.1.4 배열 삭제(DELETE)](#113414-배열-삭제delete)
      - [1.13.4.2 다양한 배열 관련 기능(함수)](#11342-다양한-배열-관련-기능함수)
        - [1.13.4.2.1 `push()` - 배열의 끝에 요소 추가](#113421-push---배열의-끝에-요소-추가)
        - [1.13.4.2.2 `pop()` - 끝의 아이템을 반환 후 배열에서 삭제](#113422-pop---끝의-아이템을-반환-후-배열에서-삭제)
        - [1.13.4.2.3 `shift()` - 배열의 첫번째 아이템을 반환 후 삭제](#113423-shift---배열의-첫번째-아이템을-반환-후-삭제)
        - [1.13.4.2.4 `concat()` - 배열 합치기](#113424-concat---배열-합치기)
        - [1.13.4.2.5 `join(item)` - 배열을 문자열로 변환](#113425-joinitem---배열을-문자열로-변환)
        - [1.13.4.2.6 `reverse()` - 배열의 순서 뒤집기](#113426-reverse---배열의-순서-뒤집기)
        - [1.13.4.2.7 `slice(start, end)` - 배열의 일부를 잘라내기](#113427-slicestart-end---배열의-일부를-잘라내기)
        - [1.13.4.2.8 `forEach()` - 배열의 각 요소에 대해 함수를 실행](#113428-foreach---배열의-각-요소에-대해-함수를-실행)
        - [1.13.4.2.9 `map()` - 배열의 각 요소에 대해 함수를 실행하고 새로운 배열 반환](#113429-map---배열의-각-요소에-대해-함수를-실행하고-새로운-배열-반환)
        - [1.13.4.2.10 `indexOf()` - 배열에서 특정 요소의 인덱스 찾기](#1134210-indexof---배열에서-특정-요소의-인덱스-찾기)
        - [1.13.4.2.11 `findIndex()` - 배열에서 특정 요소의 인덱스 찾기](#1134211-findindex---배열에서-특정-요소의-인덱스-찾기)
        - [1.13.4.2.12 `find()` - 배열에서 특정 요소 찾기](#1134212-find---배열에서-특정-요소-찾기)
        - [1.13.4.2.13 `filter()` - 배열에서 특정 조건을 만족하는 요소들로 새로운 배열 생성](#1134213-filter---배열에서-특정-조건을-만족하는-요소들로-새로운-배열-생성)
  - [1.14 Section11. Javascript(Vanilla JS) 중급](#114-section11-javascriptvanilla-js-중급)
    - [1.14.1 삼항 연산자](#1141-삼항-연산자)
    - [1.14.2 함수의 기본 인자(파라미터) 값 설정](#1142-함수의-기본-인자파라미터-값-설정)
    - [1.14.3 구조 분해 할당(비구조화 할당) 문법](#1143-구조-분해-할당비구조화-할당-문법)
    - [1.14.4 배열 분해 할당](#1144-배열-분해-할당)
    - [1.14.5 유용한 구조 분해 할당 문법 활용 팁](#1145-유용한-구조-분해-할당-문법-활용-팁)
      - [1.14.5.1 변수값 교환](#11451-변수값-교환)
      - [1.14.5.2 함수 리턴 시 여러 데이터 넘겨주기](#11452-함수-리턴-시-여러-데이터-넘겨주기)
      - [1.14.5.3 문자열 분리해서 각각의 변수에 대입](#11453-문자열-분리해서-각각의-변수에-대입)
    - [1.14.6 Rest 파라미터](#1146-rest-파라미터)
    - [1.14.7 Spread 연산자](#1147-spread-연산자)
...
##### 1.11.1.4.2 ES6 화살표 함수<sup>Arrow function</sup>
```javascript
let func = (매개변수) => expression;
```

## 1.12 Section10. Javascript(Vanilla JS) 함수와 객체
### 1.12.1 객체 선언기법 이해
> - 📕PDF
...
## 1.13 Section11. Javascript(Vanilla JS) 반복문/배열
...
##### 1.13.4.1.2 배열 읽기(READ)
```javascript 
consolg.log(arr[0], arr[arr.length - 1]);
```

##### 1.13.4.1.3 배열 수정(UPDATE)
```javascript   
arr[0] = 100;
```

##### 1.13.4.1.4 배열 삭제(DELETE)
...
#### 1.13.4.2 다양한 배열 관련 기능(함수)
##### 1.13.4.2.1 `push()` - 배열의 끝에 요소 추가  
```javascript
const arr = [1, 2, 3];
arr.push(4); // [1, 2, 3, 4]
```
##### 1.13.4.2.2 `pop()` - 끝의 아이템을 반환 후 배열에서 삭제
```javascript
const arr = [1, 2, 3];
arr.pop(); // [1, 2]
```

##### 1.13.4.2.3 `shift()` - 배열의 첫번째 아이템을 반환 후 삭제
```javascript
const arr = [1, 2, 3];
arr.shift(); // [2, 3]
```

##### 1.13.4.2.4 `concat()` - 배열 합치기
```javascript 
const arr1 = [1, 2, 3];
const arr2 = [4, 5, 6];
...
##### 1.13.4.2.5 `join(item)` - 배열을 문자열로 변환
```javascript
const arr = [1, 2, 3];
const str = arr.join(", "); // "1, 2, 3"
```

##### 1.13.4.2.6 `reverse()` - 배열의 순서 뒤집기
```javascript
const arr = [1, 2, 3];
arr.reverse(); // [3, 2, 1]
```

##### 1.13.4.2.7 `slice(start, end)` - 배열의 일부를 잘라내기
```javascript
const arr = [1, 2, 3, 4, 5];
arr.slice(1, 3); // [2, 3]
```

##### 1.13.4.2.8 `forEach()` - 배열의 각 요소에 대해 함수를 실행
```javascript   
const arr = ['first', 'second', 'third'];
...
##### 1.13.4.2.9 `map()` - 배열의 각 요소에 대해 함수를 실행하고 새로운 배열 반환
```javascript
const arr = [1, 2, 3];
...
##### 1.13.4.2.10 `indexOf()` - 배열에서 특정 요소의 인덱스 찾기
```javascript
const arr = ['first', 'second', 'third'];   
arr.indexOf('second'); // 1
```

##### 1.13.4.2.11 `findIndex()` - 배열에서 특정 요소의 인덱스 찾기
```javascript
const myArray = [
  {
    name: "John",
...
##### 1.13.4.2.12 `find()` - 배열에서 특정 요소 찾기
```javascript
console.log(myArray.find((item) => item.name === "John")); // { name: 'John', age: 25 }
```

##### 1.13.4.2.13 `filter()` - 배열에서 특정 조건을 만족하는 요소들로 새로운 배열 생성
```javascript
const arr = [1, 2, 3, 4, 5];
...
## 1.14 Section11. Javascript(Vanilla JS) 중급
> - 📕PDF
...
### 1.14.5 유용한 구조 분해 할당 문법 활용 팁
#### 1.14.5.1 변수값 교환
```javascript   
[a, b] = [b, a];
```

#### 1.14.5.2 함수 리턴 시 여러 데이터 넘겨주기
```javascript
function getData() {
    return [1, 2, 3];
}
