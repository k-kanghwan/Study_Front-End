...
- [2 HTML/CSS](#2-htmlcss)
  ...
  - [2.2 Section1. 강의 준비](#22-section1-강의-준비)
    - [2.2.1 설치](#221-설치)
  - [2.3 Section2. 모던 웹 기본 기술 이해](#23-section2-모던-웹-기본-기술-이해)
    - [2.3.1 웹 기본 기술 이해와 정리](#231-웹-기본-기술-이해와-정리)
    - [2.3.2 HTML](#232-html)
      - [2.3.2.1 ⭐️ 주요 META NAME(가장 일반적으로 많이 사용)](#2321-️-주요-meta-name가장-일반적으로-많이-사용)
      - [2.3.2.2 호환성 관련 태그](#2322-호환성-관련-태그)
      - [2.3.2.3 반응형 웹 관련 태그](#2323-반응형-웹-관련-태그)
      - [2.3.2.4 LINK](#2324-link)
      - [2.3.2.5 STYLE](#2325-style)
      - [2.3.2.6 주요 body 내의 태그](#2326-주요-body-내의-태그)
      - [2.3.2.7 Semantic Web](#2327-semantic-web)
      - [2.3.2.8 알아둘 사항](#2328-알아둘-사항)
      - [2.3.2.9 이미지](#2329-이미지)
  - [2.4 Section3. 모던 웹의 핵심 상세한 CSS 기본](#24-section3-모던-웹의-핵심-상세한-css-기본)
    - [2.4.1 CSS 기본 정리](#241-css-기본-정리)
      - [2.4.1.1 CSS란?](#2411-css란)
      - [2.4.1.2 Selector(CSS Selector 라고도 함)](#2412-selectorcss-selector-라고도-함)
      - [2.4.1.3 HTML CSS 연동 방법](#2413-html-css-연동-방법)
        - [2.4.1.3.1 적용할 태그에 style 속성으로 넣기(해당 태그에만 적용)](#24131-적용할-태그에-style-속성으로-넣기해당-태그에만-적용)
        - [2.4.1.3.2 HTML 문서 `<head>`에 `<style>...</style>` 태그로 넣기(현재 html에 적용 가능)](#24132-html-문서-head에-stylestyle-태그로-넣기현재-html에-적용-가능)
        - [2.4.1.3.3 HTML 문서 `<head>`안에 CSS 파일로 링크하기](#24133-html-문서-head안에-css-파일로-링크하기)
      - [2.4.1.4 Reset CSS](#2414-reset-css)
    - [2.4.2 CSS 단위](#242-css-단위)
      - [2.4.2.1 CSS 크기 단위](#2421-css-크기-단위)
      - [2.4.2.2 반응형 Viewport 단위](#2422-반응형-viewport-단위)
        - [2.4.2.2.1 Viewport 단위](#24221-viewport-단위)
      - [2.4.2.3 색상 표현 단위](#2423-색상-표현-단위)
    - [2.4.3 CSS Selector](#243-css-selector)
      - [2.4.3.1 속성 Selector](#2431-속성-selector)
        - [2.4.3.1.1 `[속성~="값"]` - 속성값이 "값"을 (공백으로 분리된) 포함하는 경우](#24311-속성값---속성값이-값을-공백으로-분리된-포함하는-경우)
        - [2.4.3.1.2 `[속성|="값"]` - 속성값이 "값"이거나 "값-"으로 시작하는 모든 태그(요소)(ex: "en-US")](#24312-속성값---속성값이-값이거나-값-으로-시작하는-모든-태그요소ex-en-us)
        - [2.4.3.1.3 `[속성^="값"]` - 속성값이 "값"으로 시작하는 경우](#24313-속성값---속성값이-값으로-시작하는-경우)
        - [2.4.3.1.4 `[속성$="값"]` - 속성값이 "값"으로 끝나는 경우](#24314-속성값---속성값이-값으로-끝나는-경우)
        - [2.4.3.1.5 `[속성*="값"]` - 속성값이 "값"을 포함하는 경우](#24315-속성값---속성값이-값을-포함하는-경우)
      - [2.4.3.2 복합 Selector(Combinator)](#2432-복합-selectorcombinator)
        - [2.4.3.2.1 후손 셀렉터(Descendant Selector)](#24321-후손-셀렉터descendant-selector)
        - [2.4.3.2.2 자식 셀렉터(Child Selector)](#24322-자식-셀렉터child-selector)
        - [2.4.3.2.3 인접 형제 셀렉터(Adjacent Sibling Selector)](#24323-인접-형제-셀렉터adjacent-sibling-selector)
        - [2.4.3.2.4 일반 형제 셀렉터(General Sibling Selector)](#24324-일반-형제-셀렉터general-sibling-selector)
      - [2.4.3.3 가상 클래스 셀렉터(Pseudo-class Selector)](#2433-가상-클래스-셀렉터pseudo-class-selector)
        - [2.4.3.3.1 가상클래스 종류](#24331-가상클래스-종류)
        - [2.4.3.3.2 UI 요소 상태 셀렉터(UI Element State Pseudo-Class)](#24332-ui-요소-상태-셀렉터ui-element-state-pseudo-class)
        - [2.4.3.3.3 구조 가상 클래스 셀렉터(Structural Pseudo-Class Selector)](#24333-구조-가상-클래스-셀렉터structural-pseudo-class-selector)
        - [2.4.3.3.4 부정 셀렉터(Negation Pseudo-Class Selector)](#24334-부정-셀렉터negation-pseudo-class-selector)
        - [2.4.3.3.5 정합성 체크 셀렉터(Validity Pseudo-Class Selector)](#24335-정합성-체크-셀렉터validity-pseudo-class-selector)
        - [2.4.3.3.6 가상 요소 셀렉터(Pseudo-element Selector)](#24336-가상-요소-셀렉터pseudo-element-selector)
  - [2.5 Section4. 모던 웹의 핵심 상세한 CSS 기본 프로퍼티](#25-section4-모던-웹의-핵심-상세한-css-기본-프로퍼티)
    - [2.5.1 CSS BOX MODEL(박스 모델) 이해](#251-css-box-model박스-모델-이해)
      - [2.5.1.1 BOX Model property](#2511-box-model-property)
      - [2.5.1.2 주요 프로퍼티property](#2512-주요-프로퍼티property)
        - [2.5.1.2.1 width, height](#25121-width-height)
        - [2.5.1.2.2 margin / padding](#25122-margin--padding)
        - [2.5.1.2.3 참고](#25123-참고)
        - [2.5.1.2.4 border](#25124-border)
        - [2.5.1.2.5 box-sizing](#25125-box-sizing)
    - [2.5.2 CSS background 이해](#252-css-background-이해)
      - [2.5.2.1 background-image 프로퍼티](#2521-background-image-프로퍼티)
      - [2.5.2.2 background-repeat 프로퍼티](#2522-background-repeat-프로퍼티)
      - [2.5.2.3 background-size 프로퍼티](#2523-background-size-프로퍼티)
      - [2.5.2.4 background-attachment 프로퍼티](#2524-background-attachment-프로퍼티)
      - [2.5.2.5 background-position 프로퍼티](#2525-background-position-프로퍼티)
      - [2.5.2.6 background-color 프로퍼티](#2526-background-color-프로퍼티)
      - [2.5.2.7 background 단축 프로퍼티](#2527-background-단축-프로퍼티)
    - [2.5.3 CSS block과 inline 이해](#253-css-block과-inline-이해)
      - [2.5.3.1 block 특성](#2531-block-특성)
      - [2.5.3.2 inline 특성](#2532-inline-특성)
      - [2.5.3.3 CSS display 프로퍼티](#2533-css-display-프로퍼티)
      - [2.5.3.4 CSS visibility 프로퍼티](#2534-css-visibility-프로퍼티)
      - [2.5.3.5 inline-block 특성](#2535-inline-block-특성)
    - [2.5.4 CSS font 이해](#254-css-font-이해)
      - [2.5.4.1 font-size 프로퍼티](#2541-font-size-프로퍼티)
      - [2.5.4.2 font-family 프로퍼티](#2542-font-family-프로퍼티)
      - [2.5.4.3 웹폰트 사용법](#2543-웹폰트-사용법)
      - [2.5.4.4 font-style 프로퍼티](#2544-font-style-프로퍼티)
      - [2.5.4.5 font-weight 프로퍼티](#2545-font-weight-프로퍼티)
      - [2.5.4.6 font-variant 프로퍼티](#2546-font-variant-프로퍼티)
      - [2.5.4.7 line-height 프로퍼티](#2547-line-height-프로퍼티)
      - [2.5.4.8 font 단축 프로퍼티](#2548-font-단축-프로퍼티)
      - [2.5.4.9 letter-spacing, word-spacing 프로퍼티](#2549-letter-spacing-word-spacing-프로퍼티)
      - [2.5.4.10 text-align 프로퍼티](#25410-text-align-프로퍼티)
      - [2.5.4.11 text-decoration 프로퍼티](#25411-text-decoration-프로퍼티)
      - [2.5.4.12 white-space 프로퍼티](#25412-white-space-프로퍼티)
      - [2.5.4.13 text-overflow 프로퍼티](#25413-text-overflow-프로퍼티)
  - [2.6 Section5. 모던 웹의 핵심 상세한 CSS 배치와 애니메이션](#26-section5-모던-웹의-핵심-상세한-css-배치와-애니메이션)
    - [2.6.1 CSS position 이해](#261-css-position-이해)
      - [2.6.1.1 정적 위치 (Static Position)](#2611-정적-위치-static-position)
      - [2.6.1.2 상대 위치 (Relative Position)](#2612-상대-위치-relative-position)
      - [2.6.1.3 절대 위치 (Absolute Position)](#2613-절대-위치-absolute-position)
      - [2.6.1.4 고정 위치 (Fixed Position)](#2614-고정-위치-fixed-position)
      - [2.6.1.5 z-index, overflow 프로퍼티](#2615-z-index-overflow-프로퍼티)
      - [2.6.1.6 overflow 프로퍼티](#2616-overflow-프로퍼티)
    - [2.6.2 CSS transition 이해](#262-css-transition-이해)
      - [2.6.2.1 정의](#2621-정의)
      - [2.6.2.2 주요 CSS transition 프로퍼티](#2622-주요-css-transition-프로퍼티)
      - [2.6.2.3 활용 예](#2623-활용-예)
      - [2.6.2.4 transition-timing-function](#2624-transition-timing-function)
        - [2.6.2.4.1 주요 transition-timing-function 프로퍼티 값](#26241-주요-transition-timing-function-프로퍼티-값)
      - [2.6.2.5 transition-delay](#2625-transition-delay)
      - [2.6.2.6 transition 단축 프로퍼티](#2626-transition-단축-프로퍼티)
    - [2.6.3 CSS animation 이해](#263-css-animation-이해)
      - [2.6.3.1 정의](#2631-정의)
      - [2.6.3.2 주요 CSS animation 프로퍼티](#2632-주요-css-animation-프로퍼티)
      - [2.6.3.3 keyframes 문법](#2633-keyframes-문법)
      - [2.6.3.4 주요 CSS animation 프로퍼티](#2634-주요-css-animation-프로퍼티)
      - [2.6.3.5 animation-duration, animation-delay](#2635-animation-duration-animation-delay)
      - [2.6.3.6 animation-iteration-count](#2636-animation-iteration-count)
      - [2.6.3.7 animation-direction](#2637-animation-direction)
      - [2.6.3.8 animation-fill-mode](#2638-animation-fill-mode)
      - [2.6.3.9 animation-play-state](#2639-animation-play-state)
      - [2.6.3.10 animation 단축 프로퍼티](#26310-animation-단축-프로퍼티)
    - [2.6.4 transition과 animation 비교](#264-transition과-animation-비교)
    - [2.6.5 CSS transform 이해](#265-css-transform-이해)
      - [2.6.5.1 정의](#2651-정의)
      - [2.6.5.2 주요 transform 함수](#2652-주요-transform-함수)
      - [2.6.5.3 transform-origin 프로퍼티](#2653-transform-origin-프로퍼티)
    - [2.6.6 CSS float 이해](#266-css-float-이해)
  - [2.7 Section6. 중급 CSS와 반응형 기능](#27-section6-중급-css와-반응형-기능)
    - [2.7.1 CSS 상속 이해](#271-css-상속-이해)
      - [2.7.1.1 주요 프로퍼티별 상속 여부 정리](#2711-주요-프로퍼티별-상속-여부-정리)
        - [2.7.1.1.1 상속 가능](#27111-상속-가능)
        - [2.7.1.1.2 상속 불가](#27112-상속-불가)
        - [2.7.1.1.3 강제 상속](#27113-강제-상속)
      - [2.7.1.2 CSS 우선순위와 Cascading](#2712-css-우선순위와-cascading)
        - [2.7.1.2.1 Cascading 기본규칙](#27121-cascading-기본규칙)
      - [2.7.1.3 CSS 우선순위 (명시도 계산) 기본 규칙](#2713-css-우선순위-명시도-계산-기본-규칙)
    - [2.7.2 CSS media query와 반응형(responsive) 레이아웃](#272-css-media-query와-반응형responsive-레이아웃)
      - [2.7.2.1 반응형 웹](#2721-반응형-웹)
        - [2.7.2.1.1 적응형 웹 vs 반응형 웹](#27211-적응형-웹-vs-반응형-웹)
        - [2.7.2.1.2 pixel과 viewport](#27212-pixel과-viewport)
      - [2.7.2.2 레이아웃과 미디어 쿼리](#2722-레이아웃과-미디어-쿼리)
      - [2.7.2.3 미디어 쿼리 기본 문법](#2723-미디어-쿼리-기본-문법)
      - [2.7.2.4 참고해상도](#2724-참고해상도)
      - [2.7.2.5 미디어 쿼리 예시](#2725-미디어-쿼리-예시)
  - [2.8 Section7. CSS Flexbox(레이아웃 핵심)](#28-section7-css-flexbox레이아웃-핵심)
    - [2.8.1 CSS flexbox](#281-css-flexbox)
      - [2.8.1.1 정의](#2811-정의)
      - [2.8.1.2 수평 정렬 방법과 flexbox(Flexible box)](#2812-수평-정렬-방법과-flexboxflexible-box)
    - [2.8.2 flexbox의 이해](#282-flexbox의-이해)
      - [2.8.2.1 flexbox 사용 방법](#2821-flexbox-사용-방법)
      - [2.8.2.2 flexbox conainer 관련 프로퍼티](#2822-flexbox-conainer-관련-프로퍼티)
    - [2.8.3 flex container 프로퍼티](#283-flex-container-프로퍼티)
      - [2.8.3.1 팁 : div 박스 내의 텍스트의 가운데 정렬](#2831-팁--div-박스-내의-텍스트의-가운데-정렬)
      - [2.8.3.2 flex-direction](#2832-flex-direction)
      - [2.8.3.3 flex-wrap](#2833-flex-wrap)
      - [2.8.3.4 flex-flow](#2834-flex-flow)
      - [2.8.3.5 justify-content](#2835-justify-content)
      - [2.8.3.6 align-items 와 align-content](#2836-align-items-와-align-content)
    - [2.8.4 flexbox item 관련 프로퍼티](#284-flexbox-item-관련-프로퍼티)
      - [2.8.4.1 flex item 관련 프로퍼티 요약](#2841-flex-item-관련-프로퍼티-요약)
      - [2.8.4.2 order](#2842-order)
      - [2.8.4.3 flex-grow](#2843-flex-grow)
      - [2.8.4.4 flex-shrink](#2844-flex-shrink)
      - [2.8.4.5 flex-basis](#2845-flex-basis)
      - [2.8.4.6 flex](#2846-flex)
      - [2.8.4.7 align-self](#2847-align-self)
  - [2.9 Section8. 모던 웹페이지 제작](#29-section8-모던-웹페이지-제작)
    - [2.9.1 Header 설정](#291-header-설정)
      - [2.9.1.1 meta 태그 설정](#2911-meta-태그-설정)
      - [2.9.1.2 open graph 설정](#2912-open-graph-설정)
      - [2.9.1.3 twitter card 설정](#2913-twitter-card-설정)
      - [2.9.1.4 favicon 설정](#2914-favicon-설정)
      - [2.9.1.5 CSS Reset](#2915-css-reset)
      - [2.9.1.6 font 설정](#2916-font-설정)
    - [2.9.2 CSS 기본 설정](#292-css-기본-설정)
      - [2.9.2.1 `a` 태그 초기화](#2921-a-태그-초기화)
      - [2.9.2.2 CSS 작명 규칙(BEM: Block Element Modifier)](#2922-css-작명-규칙bem-block-element-modifier)
      - [2.9.2.3 background 설정](#2923-background-설정)
    - [2.9.3 section 작성](#293-section-작성)
      - [2.9.3.1 fontawesome 사용](#2931-fontawesome-사용)
      - [2.9.3.2 box-shadow 설정](#2932-box-shadow-설정)
      - [2.9.3.3 list-style 글머리표시 제거](#2933-list-style-글머리표시-제거)
      - [2.9.3.4 text-overflow 사용방법](#2934-text-overflow-사용방법)
    - [2.9.4 transition 효과 설정](#294-transition-효과-설정)
...
#### 2.3.2.1 ⭐️ 주요 META NAME(가장 일반적으로 많이 사용)
...
## 2.4 Section3. 모던 웹의 핵심 상세한 CSS 기본
### 2.4.1 CSS 기본 정리
> - 📕PDF
...
#### 2.4.1.2 Selector(CSS Selector 라고도 함)
...
#### 2.4.1.3 HTML CSS 연동 방법
##### 2.4.1.3.1 적용할 태그에 style 속성으로 넣기(해당 태그에만 적용)
> 가급적 지양할 것
```html
<!DOCTYPE html>
<html>
...
##### 2.4.1.3.2 HTML 문서 `<head>`에 `<style>...</style>` 태그로 넣기(현재 html에 적용 가능)
```html
<!DOCTYPE html>
<html>
    <head>
...
##### 2.4.1.3.3 HTML 문서 `<head>`안에 CSS 파일로 링크하기
...
#### 2.4.2.2 반응형 Viewport 단위
- viewport 단위는 <u>화면 크기에 따라 상대적인 크기를 가짐</u>

##### 2.4.2.2.1 Viewport 단위
| 단위  | 설명                                                                 |
| :---: | -------------------------------------------------------------------- |
...
##### 2.4.3.1.1 `[속성~="값"]` - 속성값이 "값"을 (공백으로 분리된) 포함하는 경우
...
##### 2.4.3.1.2 `[속성|="값"]` - 속성값이 "값"이거나 "값-"으로 시작하는 모든 태그(요소)(ex: "en-US")
...
##### 2.4.3.1.3 `[속성^="값"]` - 속성값이 "값"으로 시작하는 경우
...
##### 2.4.3.1.4 `[속성$="값"]` - 속성값이 "값"으로 끝나는 경우
...
##### 2.4.3.1.5 `[속성*="값"]` - 속성값이 "값"을 포함하는 경우
...
#### 2.4.3.2 복합 Selector(Combinator)
...
##### 2.4.3.2.1 후손 셀렉터(Descendant Selector)
...
##### 2.4.3.2.2 자식 셀렉터(Child Selector)
...
##### 2.4.3.2.3 인접 형제 셀렉터(Adjacent Sibling Selector)
...
##### 2.4.3.2.4 일반 형제 셀렉터(General Sibling Selector)
...
#### 2.4.3.3 가상 클래스 셀렉터(Pseudo-class Selector)
> - 🧪실습파일
...
##### 2.4.3.3.2 UI 요소 상태 셀렉터(UI Element State Pseudo-Class)
...
##### 2.4.3.3.3 구조 가상 클래스 셀렉터(Structural Pseudo-Class Selector)
> - 🧪실습파일
...
##### 2.4.3.3.4 부정 셀렉터(Negation Pseudo-Class Selector)
...
##### 2.4.3.3.5 정합성 체크 셀렉터(Validity Pseudo-Class Selector)
> - 🧪실습파일
...
##### 2.4.3.3.6 가상 요소 셀렉터(Pseudo-element Selector)
> - 🧪실습파일
...
## 2.5 Section4. 모던 웹의 핵심 상세한 CSS 기본 프로퍼티
> - 📕PDF
...
#### 2.5.1.2 주요 프로퍼티<sup>property</sup>
##### 2.5.1.2.1 width, height
> - 🧪실습파일
...
#### 2.5.2.2 background-repeat 프로퍼티
|   속성    | 설명                                                                 |
| :-------: | -------------------------------------------------------------------- |
...
#### 2.5.2.4 background-attachment 프로퍼티
- 배경 이미지의 스크롤 동작을 설정
...
#### 2.5.4.4 font-style 프로퍼티
- 글자 스타일 설정
    - normal : 일반 글자(디폴트)
    - italic : 기울임꼴
    - oblique : 비스듬한 글자

#### 2.5.4.5 font-weight 프로퍼티
- 글자 두께 설정
...
## 2.6 Section5. 모던 웹의 핵심 상세한 CSS 배치와 애니메이션
### 2.6.1 CSS position 이해
> - 📕PDF
...
#### 2.6.2.2 주요 CSS transition 프로퍼티
| 프로퍼티                   | 설명                                                                      |
| -------------------------- | ------------------------------------------------------------------------- |
...
#### 2.6.2.4 transition-timing-function
> - 🧪실습파일
>   - [x] [css_transition](https://codesandbox.io/p/sandbox/csstransition-r6bpq "Go to url")

##### 2.6.2.4.1 주요 transition-timing-function 프로퍼티 값
- default : ease
...
#### 2.6.3.4 주요 CSS animation 프로퍼티
> transition-timing-function 과 동일

#### 2.6.3.5 animation-duration, animation-delay
...
#### 2.6.3.6 animation-iteration-count
- 정수 또는 infinite로 설정 가능
```css
animation-iteration-count: 3; /* 3회 반복 */
```

#### 2.6.3.7 animation-direction
|    프로퍼티 값    | 설명                                           |
| :---------------: | :--------------------------------------------- |
...
#### 2.6.3.9 animation-play-state
- running : 애니메이션 진행 중(디폴트)
- paused : 애니메이션 일시 정지


#### 2.6.3.10 animation 단축 프로퍼티
```css
animation: name duration timing-function delay iteration-count direction fill-mode play-state;
```


### 2.6.4 transition과 animation 비교 
...
#### 2.7.1.2 CSS 우선순위와 Cascading

##### 2.7.1.2.1 Cascading 기본규칙
...
### 2.7.2 CSS media query와 반응형(responsive) 레이아웃
> - 📕PDF
...
## 2.8 Section7. CSS Flexbox(레이아웃 핵심)
> - 📕PDF
...
#### 2.8.1.2 수평 정렬 방법과 flexbox(Flexible box)
- 뷰포트나 요소 사이즈가 불명확하거나, 동적으로 변할 때에도 요소를 적절히 배치할 수 있는 기능을 제공

### 2.8.2 flexbox의 이해 

#### 2.8.2.1 flexbox 사용 방법
```css
.container {
...
#### 2.8.3.1 팁 : div 박스 내의 텍스트의 가운데 정렬
...
#### 2.8.3.5 justify-content
- 주 축(main axis) 기반 수평 정렬 방법 설정

#### 2.8.3.6 align-items 와 align-content
...
#### 2.9.1.2 open graph 설정
#### 2.9.1.3 twitter card 설정
#### 2.9.1.4 favicon 설정
1. 일반적인 설정 
2. 애플 터치 아이콘 설정
3. 인터넷 익스플로러 설정
...
#### 2.9.2.2 CSS 작명 규칙(BEM: Block Element Modifier)
- 단어와 단어는 `-`로 연결 
- 하위요소는 `__`로 연결
- modifier는 `--`로 연결
- 소문자로 작성
